...
import { ChevronLeft, MapPin, Calendar, ShieldCheck, Square, Bed, Layers, Map, FileText, Phone, ChevronRight } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 flex-1">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-xl overflow-hidden">
          ...
          <div className="p-6 sm:p-8">
            <h1 className="text-xl sm:text-2xl font-extrabold text-slate-900">{item.tieude}</h1>
            <p className="mt-4 text-slate-700 text-sm leading-relaxed">{item.moTa}</p>
          </div>
        </div>
      </main>
      <Footer />
