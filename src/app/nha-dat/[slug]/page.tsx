        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-xl overflow-hidden">
          ...
          <div class="p-6 sm:p-8">
            <div class="flex items-center justify-between">
              ...
              <span class="text-xs text-slate-400 font-bold uppercase bg-slate-50 px-2.5 py-1 rounded-lg border flex items-center gap-1">
                <ShieldCheck class="w-4 h-4 text-emerald-500" /> {item.phapLy || 'Sổ hồng chính chủ'}
              </span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 mb-6">
              {item.linkMap && <a href={item.linkMap} target="_blank" rel="noopener noreferrer" class="bg-emerald-50 text-emerald-700 font-bold border rounded-xl py-2.5 px-3 text-center text-xs flex items-center justify-center gap-1.5"><Map class="w-4 h-4" /> Vị Trí Bản Đồ</a>}
              {item.anhSoDo && <a href={item.anhSoDo} target="_blank" rel="noopener noreferrer" class="bg-indigo-50 text-indigo-700 font-bold border rounded-xl py-2.5 px-3 text-center text-xs flex items-center justify-center gap-1.5"><FileText class="w-4 h-4" /> Sổ Hồng Bản Vẽ</a>}
            </div>
