        ...
        <div className="fixed inset-0 z-[60] flex justify-end">
          ...
          <div className="relative w-64 max-w-[80%] bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <div className="flex-1 overflow-y-auto py-4 flex flex-col gap-2 px-3">
              ...
              <Link href="/?showFavorites=true" onClick={() => setIsMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-slate-700 hover:bg-red-50 hover:text-red-600 rounded-2xl font-bold transition-colors">
                <Heart size={18} className="text-red-500" /> Tin đã lưu
              </Link>
