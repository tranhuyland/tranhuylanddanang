...
export default function FilterWidget({
  ...
  // Component con chứa 4 ô chọn (tái sử dụng cho cả Máy tính và Điện thoại)
  const Fields = () => (
    <>
  ...
  return (
    <>
      ...
      {/* 2. GIAO DIỆN DRAWER TRƯỢT LÊN TRÊN ĐIỆN THOẠI (Bấm nút ở Header mới gọi ra) */}
      {isDrawerOpen && (
