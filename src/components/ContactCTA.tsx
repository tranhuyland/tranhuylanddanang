        ...
        <div className="bg-gradient-to-r from-amber-500 to-yellow-400 rounded-[2.5rem] p-10 lg:p-14 text-slate-900 shadow-md">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="tel:0931555551" className="border border-slate-900 hover:bg-slate-900/10 px-7 py-4 rounded-2xl font-extrabold text-sm transition-all">Hotline: 0931 555 551</a>
            </div>
          </div>
        </div>
      </section>
